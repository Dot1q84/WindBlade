...
public class CropImageView extends ImageViewTouchBase {
	...
	public boolean onTouchEvent(@NonNull MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			if (motionHighlightView != null
					&& event.getPointerId(event.getActionIndex()) == validPointerId) {
		...
		if (cropAreaListener != null) {
			cropAreaListener.areaChangedAfterTouch();
		}
		return true;
	}
	...
	protected void centerBasedOnHighlightView(HighlightView hv) {
